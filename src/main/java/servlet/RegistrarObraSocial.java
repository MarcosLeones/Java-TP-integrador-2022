...
/**
 * Servlet implementation class RegistrarObraSocial
 */
@WebServlet("/RegistrarObraSocial")
public class RegistrarObraSocial extends HttpServlet {
